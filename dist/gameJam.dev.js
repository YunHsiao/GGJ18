...
var FPCamera = (function (superclass) {
  ...
  FPCamera.prototype.start = function start () {
    ...
    if (!this.col) { return; }
    this.col.body.setUpdateMode(true, true);
    this.col.body.setFreezeRotation(true);
  ...
  FPCamera.prototype.toggleCollision = function toggleCollision () {
    ...
    this.col.body.setUpdateMode(true, this.enableCollision);
  };
...
var Portal = (function (superclass) {
  ...
  Portal.prototype.start = function start () {
    ...
    this.model._boundingBox.setTransform(this.v3, this.qt, this.v3_2, this.model._bbModelSpace);
...
//# sourceMappingURL=gameJam.dev.js.map
